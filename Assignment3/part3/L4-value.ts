...
export type Value = SExpValue | Closure | ExpEvlNormal;
...
export interface ExpEvlNormal {
    tag: "ExpEvlNormal"
    val: CExp
}

export type SExpValue = number | boolean | string | PrimOp | Closure | SymbolSExp | EmptySExp | CompoundSExp | ExpEvlNormal;
...
export const makeExpEvlNormal = (x: CExp): ExpEvlNormal => ({ tag: "ExpEvlNormal", val: x })
export const isExpEvlNormal = (x: any): x is ExpEvlNormal => x.tag === "ExpEvlNormal";
